...
final class RaceKataLeaderBoardTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        let race1 = Race(name: "Australian Grand Prix", results: [driver1, driver2, driver3])
        let race2 = Race(name: "Malaysian Grand Prix", results: [driver3, driver2, driver1])
        let race3 = Race(name: "Chinese Grand Prix", results: [driver2, driver1, driver3])
        let race4 = Race(name: "Fictional Grand Prix", results: [driver1, driver2, driver4])
        let race5 = Race(name: "Fictional Grand Prix", results: [driver4, driver2, driver1])
        driver4.algorithmVersion = 2
        let race6 = Race(name: "Fictional Grand Prix", results: [driver2, driver1, driver4])
